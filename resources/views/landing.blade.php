                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded mr-12pt z-0 o-hidden">
                                                        <div class="overlay">
                                                            <img src="{{asset('images/paths/devops_40x40%402x.png')}}"
                                                                 width="40"
                                                                 height="40"
                                                                 alt="Angular"
                                                                 class="rounded">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded mr-12pt z-0 o-hidden">
                                                        <div class="overlay">
                                                            <img src="{{asset('images/paths/redis_40x40%402x.png')}}"
                                                                 width="40"
                                                                 height="40"
                                                                 alt="Angular"
                                                                 class="rounded">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded mr-12pt z-0 o-hidden">
                                                        <div class="overlay">
                                                            <img src="{{asset('images/paths/mailchimp_40x40%402x.png')}}"
                                                                 width="40"
                                                                 height="40"
                                                                 alt="Angular"
                                                                 class="rounded">
                        ...
                        <div class="row card-group-row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="{{asset('images/paths/sketch_40x40%402x.png')}}"
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card"
                                    ...
                                    <a href="student-course.html"
                                       ...
                                       data-position=""
                                       data-height="140">
                                        <img src="{{asset('images/paths/flinto_430x168.png')}}"
                                             alt="course">
                                        <span class="overlay__content">
                                            <span class="overlay__action d-flex flex-column text-center">
                                                <i class="material-icons icon-32pt">play_circle_outline</i>
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="{{asset('images/paths/flinto_40x40%402x.png')}}"
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="{{asset('images/paths/photoshop_40x40%402x.png')}}"
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card"
                                    ...
                                    <a href="student-course.html"
                                       ...
                                       data-position=""
                                       data-height="140">
                                        <img src="{{asset('images/paths/figma_430x168.png')}}"
                                             alt="course">
                                        <span class="overlay__content">
                                            <span class="overlay__action d-flex flex-column text-center">
                                                <i class="material-icons icon-32pt">play_circle_outline</i>
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="{{asset('images/paths/figma_40x40%402x.png')}}" 
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
